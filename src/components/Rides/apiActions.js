...
export const createAsk = async ({ ...form }) => {
  ...
  try {
    const response = await axios.post(
      "http://localhost:9001/api/busines/createask",
      {
        ...form,
      }
    );
...
export const findRideById = async (rideItemId) => {
  ...
  try {
    const response = await axios.get(
      `http://localhost:9001/api/busines/findridebyid/${rideItemId}`
    );
    return response.data;
  } catch (e) {
    alert(e.response.data.message);
...
export const askForSeat = async (rideItem, applicant) => {
  ...
  try {
    const response = await axios.post(
      "http://localhost:9001/api/busines/addasktoride",
      {
        rideItem,
        applicant,
      }
...
export const confirmAsk = async (state) => {
  ...
  try {
    const response = await axios.post(
      "http://localhost:9001/api/busines/confirm-ask",
      { state }
    );
    return response;
  } catch (e) {
...
export const unconfirmAsk = async (payload) => {
  ...
  try {
    const response = await axios.post(
      "http://localhost:9001/api/busines/unconfirm-ask",
      { payload }
    );
    return response.data;
  } catch (e) {
